<meta charset="UTF-8">
   ...
   <!--  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet"> -->
    ...
    <link href="<?php echo base_url();?>/assets/styles/stylesmaterial.indigo-pink.min.css" rel="stylesheet">
     <!-- end first-->
    ...
    <link  href="<?php echo base_url();?>/assets/icons/css/font-awesome.min.css" rel="stylesheet">
