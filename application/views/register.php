...
<?php echo validation_errors();?>
        ...
        <form class="login100-form validate-form" action="<?php echo base_url();?>index.php/User/register" method="post">
          ...
          <div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
            ...
            <input class="input100" type="password" name="Cpassword" placeholder="Enter Confrim Password">
            <span class="test-danger"><?php echo form_error('Cpassword');?></span>
            <span class="focus-input100"></span>
          </div>
          ...
          <div class="wrap-input100 validate-input m-b-18" data-validate = "Account Type">
            <span class="label-input100">Account Type</span>
            <select id="select" class="input100" name="seek_com">
              <option value="">Choose ...</option>
              <option value="seeker">Seeker</option>
              <option value="company">Company</option>
            </select>
            <span class="test-danger"><?php echo form_error('seek_com');?></span>
            <span class="focus-input100"></span>
          </div>
