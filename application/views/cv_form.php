...
<div id="login">
  ...
  <form id="multiphase" onsubmit="return false">
    ...
    <div id="phase2">
        ...
        <input id="cert_name" name="cert_name"/>
        </div>

        <div>
        <p>Date of Grants</p>
        <select id="grants_day" name="grants_day">
        ...
        <select id="grants_month" name="grants_month">
        ...
        <?php $year=2019;?>
        <select id=grants_year name=grants_year>
    ...
    <div id="phase3">
        ...
        <div>
        <p>Job Position</p>
        <input id="job_pos" name="job_pos"/>
        </div>

        <div>
        <p>Time Period</p>
        <select id="time_day_from" name="time_day_from">
        <option value="0">Day</option>
        <?php 
        for ($i = 1; $i <= 31; $i++) {
        echo "<option value='.$i.'>$i</option>";
        ...
        <select id="time_month_from" name="time_month_from">
        <option value="0">Month</option>
        <option value="1">January</option>
        <option value="2">February</option>
        <option value="3">March</option>
        ...
        <?php $year2=2019;?>
        <select id="time_year_from" name="time_year_from">
        <option value="0">Year</option>
        <?php 
        for ($y = 0; $y <= 117; $y++) {
        $year2=$year2-1;
        ...
        <select id="time_day_to" name="time_day_to">
        <option value="0">Day</option>
        <?php 
        for ($i = 1; $i <= 31; $i++) {
        echo "<option value='.$i.'>$i</option>";
        ...
        <select id="time_month_to" name="time_month_to">
        <option value="0">Month</option>
        <option value="1">January</option>
        <option value="2">February</option>
        <option value="3">March</option>
        ...
        <?php $year2=2019;?>
        <select id="time_year_to" name="time_year_to">
        <option value="0">Year</option>
        <?php 
        for ($y = 0; $y <= 117; $y++) {
        $year2=$year2-1;
    ...
    <div id="phase4">
        ...
        <div>
        <p>Skill Name</p>
        <input id="skill_name" name="skill_name"/>
        </div>

        <div>
        <p>Years of experience</p>
        <select id="year_exp" name="year_exp">
        ...
        <button onclick="backPhase4()">Previous</button>
    </div>
    <!-- end phase4 -->
    ...
    <div id="phase5">
        ...
        <div>
        <p>Interest Name</p>
        <input id="interest_name" name="company_name"/>
        </div>

        <div>
        <p>Degree of interest</p>
        <select id="interest_degree" name="interest_degree">
        <option value="">choose ...</option>
        ...
        <button onclick="backPhase5()">Previous</button>
    </div>
    <!-- end phase5 -->
    ...
    <div id="phase6">
        ...
        <input id="ref_name" name="ref_name"/>
        </div>
        ...
        <div>
        <p>Email (Optional)</p>
        <input id="ref_email" name="ref_email"/>
        </div>

        <button onclick="submit()">Save</button>
        <button onclick="backPhase6()">Previous</button>
    </div>
    <!-- end phase6 -->
  </form>
</div>
